...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('portapp_asignatura', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('denominacion', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('portapp', ['Asignatura'])

        # Adding field 'Documento.asignatura'
        db.add_column('portapp_documento', 'asignatura', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portapp.Asignatura'], null=True, blank=True), keep_default=False)

        # Changing field 'CoautoriaEstudiante.fecha_verificado'
        db.alter_column('portapp_coautoriaestudiante', 'fecha_verificado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

        # Changing field 'CoautoriaEstudiante.fecha_ingreso'
        db.alter_column('portapp_coautoriaestudiante', 'fecha_ingreso', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

        # Adding unique constraint on 'CoautoriaEstudiante', fields ['coautoria', 'estudiante']
        db.create_unique('portapp_coautoriaestudiante', ['coautoria_id', 'estudiante_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CoautoriaEstudiante', fields ['coautoria', 'estudiante']
        db.delete_unique('portapp_coautoriaestudiante', ['coautoria_id', 'estudiante_id'])

        # Deleting model 'Asignatura'
        db.delete_table('portapp_asignatura')

        # Deleting field 'Documento.asignatura'
        db.delete_column('portapp_documento', 'asignatura_id')

        # Changing field 'CoautoriaEstudiante.fecha_verificado'
        db.alter_column('portapp_coautoriaestudiante', 'fecha_verificado', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'CoautoriaEstudiante.fecha_ingreso'
        db.alter_column('portapp_coautoriaestudiante', 'fecha_ingreso', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'portapp.coautoria': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'seudonimo': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'})
        },
        'portapp.coautoriaestudiante': {
            'Meta': {'unique_together': "(('estudiante', 'coautoria'),)", 'object_name': 'CoautoriaEstudiante'},
            'coautoria': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['portapp.Coautoria']"}),
            'estudiante': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['portapp.Estudiante']"}),
            'fecha_ingreso': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'fecha_verificado': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'portapp.documento': {
            ...
            'asignatura': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['portapp.Asignatura']", 'null': 'True', 'blank': 'True'}),
            ...
            'texto_completo': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
