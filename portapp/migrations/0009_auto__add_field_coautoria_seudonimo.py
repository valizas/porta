...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('portapp_coautoria', 'seudonimo', self.gf('django.db.models.fields.CharField')(default=datetime.date(2011, 12, 5), unique=True, max_length=50), keep_default=False)
