...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Coautoria.seudonimo'
        raise RuntimeError("Cannot reverse this migration. 'Coautoria.seudonimo' and its values cannot be restored.")
