...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('portapp_personaexterna', 'user', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['auth.User'], unique=True), keep_default=False)

        # Changing field 'Documento.path'
        db.alter_column('portapp_documento', 'path', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Adding field 'Docente.user'
        db.add_column('portapp_docente', 'user', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['auth.User'], unique=True), keep_default=False)

        # Adding field 'Estudiante.user'
        db.add_column('portapp_estudiante', 'user', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['auth.User'], unique=True), keep_default=False)

        # Adding field 'Coautoria.seudonimo'
        db.add_column('portapp_coautoria', 'seudonimo', self.gf('django.db.models.fields.CharField')(default='2011-11-30', max_length=50), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Documento.path'
        db.alter_column('portapp_documento', 'path', self.gf('django.db.models.fields.CharField')(max_length=500))
        ...
        # Deleting field 'Coautoria.seudonimo'
        db.delete_column('portapp_coautoria', 'seudonimo')
