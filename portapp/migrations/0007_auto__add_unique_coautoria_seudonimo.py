...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Coautoria', fields ['seudonimo']
        db.create_unique('portapp_coautoria', ['seudonimo'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Coautoria', fields ['seudonimo']
        db.delete_unique('portapp_coautoria', ['seudonimo'])
